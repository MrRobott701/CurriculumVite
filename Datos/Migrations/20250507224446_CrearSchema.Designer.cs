...
namespace Datos.Migrations
{
    ...
    [Migration("20250507224446_CrearSchema")]
    partial class CrearSchema
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entidades.Modelos.PlanesDeEstudio.AreasDeConocimiento.E_AreaConocimiento", b =>
                {
            ...
            modelBuilder.Entity("Entidades.Modelos.PlanesDeEstudio.Etapas.E_Etapa", b =>
                {
            ...
            modelBuilder.Entity("Entidades.Modelos.PlanesDeEstudio.Materias.E_Materia", b =>
                {
            ...
            modelBuilder.Entity("Entidades.Modelos.PlanesDeEstudio.PlanEstudios.E_PlanEstudio", b =>
                {
            ...
            modelBuilder.Entity("Entidades.Modelos.PlanesDeEstudio.PlanEstudios.E_PlanEstudioMateria", b =>
                {
            ...
            modelBuilder.Entity("Entidades.Modelos.PlanesDeEstudio.PlanEstudios.E_PlanEstudioMateria", b =>
                {
                    b.HasOne("Entidades.Modelos.PlanesDeEstudio.AreasDeConocimiento.E_AreaConocimiento", "AreaConocimiento")
                        .WithMany("PlanEstudioMaterias")
                        .HasForeignKey("IdAreaConocimiento")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Entidades.Modelos.PlanesDeEstudio.Etapas.E_Etapa", "Etapa")
                        .WithMany("PlanEstudioMaterias")
                        .HasForeignKey("IdEtapa")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Entidades.Modelos.PlanesDeEstudio.Materias.E_Materia", "Materia")
                        .WithMany("PlanEstudioMaterias")
                        .HasForeignKey("IdMateria")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Entidades.Modelos.PlanesDeEstudio.PlanEstudios.E_PlanEstudio", "PlanEstudio")
                        .WithMany("PlanEstudioMaterias")
